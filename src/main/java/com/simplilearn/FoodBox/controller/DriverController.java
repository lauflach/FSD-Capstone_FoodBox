...
import com.simplilearn.FoodBox.exception.OrderAlreadyDeliverException;
import com.simplilearn.FoodBox.exception.OrderAlreadyFinishException;
import com.simplilearn.FoodBox.exception.OrderNotExistException;
...
import com.simplilearn.FoodBox.model.Driver;
import com.simplilearn.FoodBox.model.Order;
import com.simplilearn.FoodBox.service.DriverServiceImpl;
...
public class DriverController {
  ...
  public Driver getDriverById(@PathVariable("id") String id)
    ...
    return driverService.getUser(id)
        .orElseThrow(() -> new UserNotExistException("User doesn't exist, please register"));
  }
  ...
  public int acceptOrder(@RequestBody String jsonOrder)
    ...
    if (res == -1) {
      throw new OrderNotExistException("Order doesn't exist, please register");
    }
    if (res == 0) {
